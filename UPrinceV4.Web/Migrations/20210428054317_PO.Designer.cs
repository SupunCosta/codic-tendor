...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("UPrinceV4.Web.Data.PurchaseOrder.POConsumables", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");

                    b.Property<string>("Bor_Id")
                        .HasColumnType("nvarchar(450)");

                    b.Property<string>("Comment")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("CpcBasicUnitOfMeasure_Id")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.Property<string>("PurchesOrder_Id")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.HasIndex("CpcBasicUnitOfMeasure_Id");

                    b.HasIndex("PurchesOrder_Id");

                    b.ToTable("POConsumables");
                });

            modelBuilder.Entity("UPrinceV4.Web.Data.PurchaseOrder.POExternalProduct", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.Property<string>("Cross_Reference")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.ToTable("POExternalProducts");
                });

            modelBuilder.Entity("UPrinceV4.Web.Data.PurchaseOrder.POHeader", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("UPrinceV4.Web.Data.PurchaseOrder.POInvolvedParties", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");

                    b.Property<string>("Customer_CabPersonCompanyId")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.Property<string>("Supplier_CabPersonCompanyId")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.HasIndex("Customer_CabPersonCompanyId");

                    b.HasIndex("PurchesOrder_Id");

                    b.HasIndex("Supplier_CabPersonCompanyId");

                    b.ToTable("POInvolvedParties");
                });

            modelBuilder.Entity("UPrinceV4.Web.Data.PurchaseOrder.POLabour", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("UPrinceV4.Web.Data.PurchaseOrder.POMaterial", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.ToTable("POMaterials");
                });

            modelBuilder.Entity("UPrinceV4.Web.Data.PurchaseOrder.POTools", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("UPrinceV4.Web.Data.PurchaseOrder.POConsumables", b =>
                {
                    b.HasOne("UPrinceV4.Web.Data.BOR.Bor", "Bor")
                        .WithMany()
                        .HasForeignKey("Bor_Id");

                    b.HasOne("UPrinceV4.Web.Data.CPC.CpcBasicUnitOfMeasure", "CpcBasicUnitOfMeasure")
                        .WithMany()
                        .HasForeignKey("CpcBasicUnitOfMeasure_Id");

                    b.HasOne("UPrinceV4.Web.Data.PurchaseOrder.POHeader", "POHeader")
                        .WithMany()
                        .HasForeignKey("PurchesOrder_Id");
            ...
            modelBuilder.Entity("UPrinceV4.Web.Data.PurchaseOrder.POInvolvedParties", b =>
                {
                    b.HasOne("UPrinceV4.Web.Data.CAB.CabPersonCompany", "CabPerson")
                        .WithMany()
                        .HasForeignKey("Customer_CabPersonCompanyId");

                    b.HasOne("UPrinceV4.Web.Data.PurchaseOrder.POHeader", "POHeader")
                        .WithMany()
                        .HasForeignKey("PurchesOrder_Id");

                    b.HasOne("UPrinceV4.Web.Data.CAB.CabPersonCompany", "SuplierPerson")
                        .WithMany()
                        .HasForeignKey("Supplier_CabPersonCompanyId");

                    b.Navigation("CabPerson");

                    b.Navigation("POHeader");

                    b.Navigation("SuplierPerson");
                });
