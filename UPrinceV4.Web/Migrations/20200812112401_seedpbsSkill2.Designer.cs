...
namespace UPrinceV4.Web.Migrations
{
    ...
    [Migration("20200812112401_seedpbsSkill2")]
    partial class seedpbsSkill2
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("UPrinceV4.Web.Data.PBS_.PbsSkill", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "8b145fdc-b666-488c-beec-f33562702460",
                            LocaleCode = "PbsSkillTeam Building Skills",
                            Name = "Team Building Skills"
                        },
                        new
                        {
                            Id = "bfd3f176-cc91-4d01-b27f-bef8888fc21c",
                            LocaleCode = "PbsSkillCollaboration",
                            Name = "Collaboration",
                            ParentId = "8b145fdc-b666-488c-beec-f33562702460"
                        },
                        new
                        {
                            Id = "0ffe382d-fe7d-4ac7-91b3-204570427c37",
                            LocaleCode = "PbsSkillCommunication",
                            Name = "Communication",
                            ParentId = "8b145fdc-b666-488c-beec-f33562702460"
                        },
                        new
                        {
                            Id = "8f992d6e-7fee-43a3-b06c-430fa4d9d8e4",
                            LocaleCode = "PbsSkillFlexibility",
                            Name = "Flexibility",
                            ParentId = "8b145fdc-b666-488c-beec-f33562702460"
                        },
                        new
                        {
                            Id = "1ae3028d-ab5b-4d88-bf4a-5bf53d969c4d",
                            LocaleCode = "PbsSkillListening",
                            Name = "Listening",
                            ParentId = "8b145fdc-b666-488c-beec-f33562702460"
                        },
                        new
                        {
                            Id = "fb88dff8-cf84-4cdb-acae-4a8b9241178f",
                            LocaleCode = "PbsSkillAnalytical Skills",
                            Name = "Analytical Skills"
                        },
                        new
                        {
                            Id = "7fd2a1b0-c559-4727-a596-dbc0af7c171e",
                            LocaleCode = "PbsSkillCritical thinking",
                            Name = "Critical thinking",
                            ParentId = "fb88dff8-cf84-4cdb-acae-4a8b9241178f"
                        },
                        new
                        {
                            Id = "a1e3c91b-a8cf-43b1-b551-8bba9f64c335",
                            LocaleCode = "PbsSkillData analysis",
                            Name = "Data analysis",
                            ParentId = "fb88dff8-cf84-4cdb-acae-4a8b9241178f"
                        },
                        new
                        {
                            Id = "4a2cb5e5-e9ab-47a6-b1c5-080bdc5d60b6",
                            LocaleCode = "PbsSkillNumeracy",
                            Name = "Numeracy",
                            ParentId = "fb88dff8-cf84-4cdb-acae-4a8b9241178f"
                        },
                        new
                        {
                            Id = "74e9f3ce-5338-467c-add0-ba7116cd300b",
                            LocaleCode = "PbsSkillReporting",
                            Name = "Reporting",
                            ParentId = "fb88dff8-cf84-4cdb-acae-4a8b9241178f"
                        });
            ...
            modelBuilder.Entity("UPrinceV4.Web.Data.PBS_.PbsProduct", b =>
                {
                    b.HasOne("UPrinceV4.Web.Data.PBS_.PbsProduct", "Parent")
                        .WithMany()
            ...
            modelBuilder.Entity("UPrinceV4.Web.Data.PBS_.PbsSkill", b =>
                {
                    b.HasOne("UPrinceV4.Web.Data.PBS_.PbsSkill", "Parent")
                        .WithMany()
                        .HasForeignKey("ParentId");
                });
