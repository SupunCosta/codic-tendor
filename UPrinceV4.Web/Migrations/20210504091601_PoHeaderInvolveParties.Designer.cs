...
namespace UPrinceV4.Web.Migrations
{
    ...
    [Migration("20210504091601_PoHeaderInvolveParties")]
    partial class PoHeaderInvolveParties
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("UPrinceV4.Web.Data.PO.POConsumables", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("UPrinceV4.Web.Data.PO.POExternalProduct", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("UPrinceV4.Web.Data.PO.POHeader", b =>
                {
                    ...
                    b.Property<string>("CustomerCabPersonCompanyId")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("CustomerCompanyId")
                        .HasColumnType("nvarchar(450)");

                    b.Property<string>("CustomerPersonCompanyId")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.HasIndex("CustomerPersonCompanyId");

                    b.HasIndex("SuplierCompanyId");

                    b.HasIndex("SupplierCabPersonCompanyId");

                    b.ToTable("POHeader");
                });

            modelBuilder.Entity("UPrinceV4.Web.Data.PO.POInvolvedParties", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("UPrinceV4.Web.Data.PO.POLabour", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("UPrinceV4.Web.Data.PO.POMaterial", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("UPrinceV4.Web.Data.PO.POTools", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("UPrinceV4.Web.Data.PO.POHeader", b =>
                {
                    b.HasOne("UPrinceV4.Web.Data.CAB.CabCompany", "CustomerCompany")
                        .WithMany()
                        .HasForeignKey("CustomerCompanyId");

                    b.HasOne("UPrinceV4.Web.Data.CAB.CabPersonCompany", "CustomerPersonCompany")
                        .WithMany()
                        .HasForeignKey("CustomerPersonCompanyId");

                    b.HasOne("UPrinceV4.Web.Data.CAB.CabCompany", "SuplierCompany")
                        .WithMany()
                        .HasForeignKey("SuplierCompanyId");

                    b.HasOne("UPrinceV4.Web.Data.CAB.CabPersonCompany", "SuplierPerson")
                        .WithMany()
                        .HasForeignKey("SupplierCabPersonCompanyId");

                    b.Navigation("CustomerCompany");

                    b.Navigation("CustomerPersonCompany");

                    b.Navigation("SuplierCompany");
