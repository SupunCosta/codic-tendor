...
namespace UPrinceV4.Web.Migrations
{
    ...
    [Migration("20200715104333_AddedBasicUnitOfMeasure")]
    partial class AddedBasicUnitOfMeasure
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("UPrinceV4.Web.Data.CAB.Address", b =>
                {
            ...
            modelBuilder.Entity("UPrinceV4.Web.Data.CAB.Company", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("UPrinceV4.Web.Data.CAB.Country", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("UPrinceV4.Web.Data.CAB.Email", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("UPrinceV4.Web.Data.CAB.LandPhone", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("UPrinceV4.Web.Data.CAB.MobilePhone", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("UPrinceV4.Web.Data.CAB.Person", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("UPrinceV4.Web.Data.CAB.PersonCompany", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.Property<string>("WorkingStatusId")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("UPrinceV4.Web.Data.CAB.Salutation", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("UPrinceV4.Web.Data.CAB.Skype", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("UPrinceV4.Web.Data.CAB.Whatsapp", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("UPrinceV4.Web.Data.CAB.WorkingStatus", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("UPrinceV4.Web.Data.CAB.Address", b =>
                {
                    b.HasOne("UPrinceV4.Web.Data.CAB.Country", "Country")
                        .WithMany()
            ...
            modelBuilder.Entity("UPrinceV4.Web.Data.CAB.CabHistoryLog", b =>
                {
                    ...
                    b.HasOne("UPrinceV4.Web.Data.CAB.Company", "Company")
                        .WithMany()
                        .HasForeignKey("CompanyId");

                    b.HasOne("UPrinceV4.Web.Data.CAB.Person", "Person")
                        .WithMany()
            ...
            modelBuilder.Entity("UPrinceV4.Web.Data.CAB.Company", b =>
                {
                    b.HasOne("UPrinceV4.Web.Data.CAB.Address", "Address")
                        .WithMany()
                        .HasForeignKey("AddressId");

                    b.HasOne("UPrinceV4.Web.Data.CAB.Email", "Email")
                        .WithMany()
                        .HasForeignKey("EmailId");

                    b.HasOne("UPrinceV4.Web.Data.CAB.LandPhone", "LandPhone")
                        .WithMany()
                        .HasForeignKey("LandPhoneId");

                    b.HasOne("UPrinceV4.Web.Data.CAB.Person", null)
                        .WithMany("CompanyList")
                        .HasForeignKey("PersonId");

                    b.HasOne("UPrinceV4.Web.Data.Users", "ChangedUser")
                        .WithMany()
            ...
            modelBuilder.Entity("UPrinceV4.Web.Data.CAB.Person", b =>
                {
                    ...
                    b.HasOne("UPrinceV4.Web.Data.CAB.MobilePhone", "MobilePhone")
                        .WithMany()
                        .HasForeignKey("MobilePhoneId");

                    b.HasOne("UPrinceV4.Web.Data.CAB.Salutation", "Salutation")
                        .WithMany()
                        .HasForeignKey("SalutationId");

                    b.HasOne("UPrinceV4.Web.Data.CAB.Skype", "Skype")
                        .WithMany()
                    ...
                    b.HasOne("UPrinceV4.Web.Data.CAB.Whatsapp", "Whatsapp")
                        .WithMany()
            ...
            modelBuilder.Entity("UPrinceV4.Web.Data.CAB.PersonCompany", b =>
                {
                    ...
                    b.HasOne("UPrinceV4.Web.Data.CAB.WorkingStatus", "WorkingStatus")
                        .WithMany()
            ...
            modelBuilder.Entity("UPrinceV4.Web.Data.CPC.CpcResourceFamily", b =>
                {
                    b.HasOne("UPrinceV4.Web.Data.CPC.CpcResourceFamily", "Parent")
                        .WithMany()
