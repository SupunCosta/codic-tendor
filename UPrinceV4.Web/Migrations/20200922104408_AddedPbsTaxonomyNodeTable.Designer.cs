...
namespace UPrinceV4.Web.Migrations
{
    ...
    [Migration("20200922104408_AddedPbsTaxonomyNodeTable")]
    partial class AddedPbsTaxonomyNodeTable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("UPrinceV4.Web.Data.PBS_.PbsTaxonomyNode", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("UPrinceV4.Web.Data.PMOL.PmolConsumable", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.ToTable("PMolConsumable");
                });

            modelBuilder.Entity("UPrinceV4.Web.Data.PMOL.PmolDocument", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.ToTable("PMolDocument");
                });

            modelBuilder.Entity("UPrinceV4.Web.Data.PMOL.PmolDocumentLink", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("UPrinceV4.Web.Data.PMOL.PmolJournal", b =>
                {
                    ...
                    b.Property<string>("LearntThings")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("UPrinceV4.Web.Data.PMOL.PmolLabour", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.ToTable("PMolLabour");
                });

            modelBuilder.Entity("UPrinceV4.Web.Data.PMOL.PmolMaterial", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("UPrinceV4.Web.Data.PMOL.PmolTools", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("UPrinceV4.Web.Data.PBS_.PbsProductTaxonomy", b =>
                {
                    ...
                    b.HasOne("UPrinceV4.Web.Data.PBS_.PbsTaxonomyNode", "PbsTaxonomyNode")
                        .WithMany()
                        .HasForeignKey("PbsTaxonomyNodeId");
                });
            ...
            modelBuilder.Entity("UPrinceV4.Web.Data.PMOL.Pmol", b =>
                {
                    b.HasOne("UPrinceV4.Web.Data.CAB.CabPerson", "Foreman")
                        .WithMany()
            ...
            modelBuilder.Entity("UPrinceV4.Web.Data.PMOL.PmolDocumentLink", b =>
                {
                    b.HasOne("UPrinceV4.Web.Data.PMOL.PmolDocument", "PmolDocument")
                        .WithMany()
