...
namespace UPrinceV4.Web.Migrations
{
    ...
    [Migration("20220302063610_projectstatuslocalizeddata")]
    partial class projectstatuslocalizeddata
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("UPrinceV4.Web.Data.BMLot.LotContractorsList", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.ToTable("LotContractorsList");
                });

            modelBuilder.Entity("UPrinceV4.Web.Data.BMLot.LotContractorTeamList", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.ToTable("LotContractorTeamList");
                });

            modelBuilder.Entity("UPrinceV4.Web.Data.BMLot.LotFileType", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.ToTable("LotFileType");

                    b.HasData(
                        new
                        {
                            Id = "qqqab9fe-msms-4088-Lot-d27008688qqq",
                            DisplayOrder = 1,
                            LanguageCode = "en",
                            Name = "pdf",
                            TypeId = "oo10e768-msms-po02-Lot-ee367a82adooo"
                        },
                        new
                        {
                            Id = "zzzab9fe-msms-4088-Lot-d27008688zzz",
                            DisplayOrder = 2,
                            LanguageCode = "en",
                            Name = "Image",
                            TypeId = "oo10e768-msms-po02-Lot-ee367a82adooo"
                        ...
                        new
                        {
                            Id = "bnb9e479-msms-40c6-Lot-e40dbe6a5bnb",
                            DisplayOrder = 3,
                            LanguageCode = "en",
                            Name = "URL",
                            TypeId = "2210e768-msms-po02-Lot-ee367a82ad22"
                        },
                        new
                        {
                            Id = "wer9e479-msms-40c6-Lot-e40dbe6a5wer",
                            DisplayOrder = 4,
                            LanguageCode = "en",
                            Name = "Word Document",
                            TypeId = "2210e768-msms-po02-Lot-ee367a82ad22"
            ...
            modelBuilder.Entity("UPrinceV4.Web.Data.BMLot.LotFinalDeliveryDocs", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.ToTable("LotFinalDeliveryDocs");
                });

            modelBuilder.Entity("UPrinceV4.Web.Data.BMLot.LotHeader", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("UPrinceV4.Web.Data.BMLot.LotHistoryLog", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.ToTable("LotHistoryLog");
                });

            modelBuilder.Entity("UPrinceV4.Web.Data.BMLot.LotProvisionalAcceptenceDocs", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.ToTable("LotProvisionalAcceptenceDocs");
                });

            modelBuilder.Entity("UPrinceV4.Web.Data.BMLot.LotStatus", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            StatusId = "d60aad0b-2e84-482b-ad25-Lot0d49477"
                        },
                        new
                        {
                        ...
                        new
                        {
                            ...
                            LanguageCode = "en",
                            Name = "In Development",
                            StatusId = "94282458-0b40-40a3-b0f9-Lot344c8f1"
                        },
                        new
                        {
                        ...
                        new
                        {
                            ...
                            LanguageCode = "en",
                            Name = "In Review",
                            StatusId = "7143ff01-d173-4a20-8c17-Lotecdb84c"
                        },
                        new
                        {
                        ...
                        new
                        {
                            ...
                            LanguageCode = "en",
                            Name = "Approved",
                            StatusId = "7bcb4e8d-8e8c-487d-8170-Lot89fc3da"
                        },
                        new
                        {
                        ...
                        new
                        {
                            ...
                            LanguageCode = "en",
                            Name = "Handed Over",
                            StatusId = "4010e768-3e06-4702-b337-Lota82addb"
                        },
                        new
                        {
            ...
            modelBuilder.Entity("UPrinceV4.Web.Data.BMLot.LotTechDocs", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.ToTable("LotTechDocs");
                });

            modelBuilder.Entity("UPrinceV4.Web.Data.BMLot.LotTechInstructionsDocs", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.ToTable("LotTechInstructionsDocs");
                });

            modelBuilder.Entity("UPrinceV4.Web.Data.BMLot.LotTenderAward", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.ToTable("LotTenderAward");
                });

            modelBuilder.Entity("UPrinceV4.Web.Data.BMLot.LotTenderDocs", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("UPrinceV4.Web.Data.ProjectStateLocalizedData", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            LanguageCode = "nl",
                            ProjectStateId = "1e276a41-26af-4340-b4bc-c9aeb107efe7"
                        },
                        new
                        {
                            Id = "12e2d6c5-1ada-4e74-88ba-ce7fbf10e27c",
                            ...
                            LanguageCode = "en",
                            ProjectStateId = "65f2f0fd-ea7a-440e-9fd4-346628ef1299"
                        },
                        new
                        {
                            Id = "2732cd5a-0941-4c56-9c13-f5fdca2ab276",
                        ...
                        new
                        {
                            ...
                            Label = "goedgekeurd",
                            LanguageCode = "nl",
                            ProjectStateId = "624b5481-fb27-44dc-9aae-5a5c85d59720"
                        },
                        new
                        {
                            Id = "5015743d-a2e6-4531-808d-d4e1400e1eed",
                            ...
                            LanguageCode = "nl",
                            ProjectStateId = "152fa5c2-e697-451a-bf3d-fa342ea95670"
                        },
                        new
                        {
                            Id = "77143c60-ff45-4ca2-8723-213d2d1c5f5a",
                        ...
                        new
                        {
                            ...
                            Label = "Handed Over",
                            LanguageCode = "en",
                            ProjectStateId = "d7e13082-77f4-44ad-8ad8-b0b9dad94ac1"
                        },
                        new
                        {
                            Id = "a35ab9fe-df57-4088-82a9-d27008688bae",
                        ...
                        {
                            Id = "bdd9e479-75b3-40c6-ad61-e40dbe6a51ac",
                            Label = "afgewerkt en doorgegeven",
                            LanguageCode = "nl",
                            ProjectStateId = "d7e13082-77f4-44ad-8ad8-b0b9dad94ac1"
                        });
                });
