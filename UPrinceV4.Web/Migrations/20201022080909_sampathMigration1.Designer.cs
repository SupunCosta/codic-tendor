...
namespace UPrinceV4.Web.Migrations
{
    ...
    [Migration("20201022080909_sampathMigration1")]
    partial class sampathMigration1
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("UPrinceV4.Web.Data.ProjectLocationDetails.Address", b =>
                {
                    ...
                    b.HasIndex("MapLocationId")
                        .IsUnique()
                        .HasFilter("[MapLocationId] IS NOT NULL");
            ...
            modelBuilder.Entity("UPrinceV4.Web.Data.ProjectLocationDetails.Geometry", b =>
                {
                    ...
                    b.HasIndex("DataSourcesId")
                        .IsUnique()
                        .HasFilter("[DataSourcesId] IS NOT NULL");
            ...
            modelBuilder.Entity("UPrinceV4.Web.Data.ProjectLocationDetails.Address", b =>
                {
                    b.HasOne("UPrinceV4.Web.Data.ProjectLocationDetails.MapLocation", null)
                        .WithOne("Address")
                        .HasForeignKey("UPrinceV4.Web.Data.ProjectLocationDetails.Address", "MapLocationId");
                });
            ...
            modelBuilder.Entity("UPrinceV4.Web.Data.ProjectLocationDetails.DataSources", b =>
                {
                    b.HasOne("UPrinceV4.Web.Data.ProjectLocationDetails.MapLocation", null)
                        .WithOne("DataSources")
                        .HasForeignKey("UPrinceV4.Web.Data.ProjectLocationDetails.DataSources", "MapLocationId");
                });

            modelBuilder.Entity("UPrinceV4.Web.Data.ProjectLocationDetails.Geometry", b =>
                {
                    b.HasOne("UPrinceV4.Web.Data.ProjectLocationDetails.DataSources", null)
                        .WithOne("Geometry")
                        .HasForeignKey("UPrinceV4.Web.Data.ProjectLocationDetails.Geometry", "DataSourcesId");
                });
