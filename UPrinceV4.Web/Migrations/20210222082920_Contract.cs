        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InvolvePartiesId = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CoporateProductCatlogId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        column: x => x.CoporateProductCatlogId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ContractId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    CabPersonId = table.Column<string>(type: "nvarchar(450)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_PLPriceList", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PLPriceList_CabPerson_CabPersonId",
            ...
            migrationBuilder.CreateIndex(
                ...
                column: "CabPersonCompanyId",
                unique: true,
                filter: "[CabPersonCompanyId] IS NOT NULL");

            migrationBuilder.CreateIndex(
                name: "IX_PLPriceList_CabPersonId",
                table: "PLPriceList",
                column: "CabPersonId");
